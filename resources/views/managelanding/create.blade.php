                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('manage.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" name="about_description" class="form-control">{{ $welcome->about_description ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">About Image</label>
                                    <input type="file" name="about_image" class="form-control"><br>
                                    @if (isset($welcome->about_image))
                                        <img src="{{ asset('storage/' . $welcome->about_image) }}"
                                            style="max-width: 200px; display: block; margin-bottom: 10px;">
                                    @endif
                                </div>
