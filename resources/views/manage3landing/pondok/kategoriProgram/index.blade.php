...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h4>Kelola Data Item Program</h4>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                    <li class="breadcrumb-item active">Data Item Program</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <div class="row">
            <div class="col-xl-12">
                <div class="card bg-info bg-gradient">
                    <div class="card-body pt-3">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <a href="{{ route('itemprogrampondok.create') }}" type="button"
                                            ...
                                            @forelse ($kategori as $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-2">
                                                        <a href="{{ route('itemprogrampondok.edit', $item) }}"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form id="deleteForm{{ $item->id }}"
                                                                                action="{{ route('itemprogrampondok.destroy', $item->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
