                                                    ...
                                                    <td class="d-flex gap-2">
                                                        @if (Auth::user()->hasRole('master-admin'))
                                                            @if ($item->status == 'pending')
                                                                <form
                                                                    action="{{ route('kegiatanpondok.approve', $item->id) }}"
                                                                ...
                                                                <form
                                                                    action="{{ route('kegiatanpondok.reject', $item->id) }}"
                                                                    method="POST" class="d-inline">
                                                                    @csrf
                                                                    <button type="submit"
                                                            ...
                                                            @else
                                                                <form
                                                                    action="{{ route('kegiatanpondok.approveDelete', $item->id) }}"
                                                                    method="POST" class="d-inline">
                                                                    @csrf
                                                                    <button type="submit"
                                                                        class="btn btn-success btn-sm">Approve</button>
                                                                ...
                                                                <form
                                                                    action="{{ route('kegiatanpondok.rejectDelete', $item->id) }}"
                                                                    method="POST" class="d-inline">
                                                                    @csrf
                                                                    <button type="submit"
                                                                        class="btn btn-danger btn-sm">Reject</button>
                                                        ...
                                                        @else
                                                            ...
                                                            <button type="button" class="btn btn-danger"
                                                                ...
                                                                data-action="{{ route('kegiatanpondok.destroy', $item->id) }}"
                                                                data-title="Hapus Data Kegiatan"
