        ...
        <div class="container-fluid">
            <div class="card bg-info bg-gradient">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('eventsmp.update', $eventsmp) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul" class="form-control"
                                        value="{{ old('judul', $eventsmp->judul) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="lokasi" class="form-label">Lokasi</label>
                                    <input type="text" name="lokasi" class="form-control"
                                        value="{{ old('lokasi', $eventsmp->lokasi) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="tanggal" class="form-label">Tanggal</label>
                                    <input type="date" name="tanggal" class="form-control"
                                        value="{{ old('tanggal', $eventsmp->tanggal) }}">
                                </div>

                                <div class="mb-3">
                                    <label for="waktu_mulai" class="form-label">Waktu Mulai</label>
                                    <input type="time" name="waktu_mulai" class="form-control"
                                        value="{{ $eventsmp->waktu_mulai }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" class="form-control">{{ old('deskripsi', $eventsmp->deskripsi) }}</textarea>
                                </div>
